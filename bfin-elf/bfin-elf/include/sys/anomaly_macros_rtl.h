...
/* 16-00-0043/05-00-0506 - "Hardware Loop Underflow Under Specific Conditions."
**
** When two consecutive hardware loops are separated by a single instruction,
** and the two hardware loops use the same loop registers, and the first loop
** contains a conditional jump to its loop bottom, the first hardware loop can
** underflow.
**
** Impacted:
